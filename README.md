<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️-->\<div align="center">
  <center><img alt="Debian 10 Desktop logo" src="./logo.png" /></center>
</div>
<div align="center">
  <center><h1 align="center">Packer Template: Debian 10 Desktop</h1></center>
</div>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://app.vagrantup.com/Megabyte/boxes/Debian-Desktop" title="Debian 10 Desktop box on VagrantUp.com" target="_blank">
...
This repository contains the source code used to automatically build minimal Debian 10 Desktop VM images. The build process closely imitates the same process used by [chef/bento](https://github.com/chef/bento). In fact, you will see that most of the `scripts/` folder is symlinked to a chef/bento submodule.

This repository automates most of the process of keeping our [Debian 10 Desktop VM images](https://app.vagrantup.com/Megabyte/boxes/Debian-Desktop) up-to-date with the latest upstream source by:
...
You can quickly use this project to create your own minimal Debian 10 Desktop box by:
...
If a new release of the Debian 10 Desktop system is available, you can update your VagrantUp box. You can do this by changing the `"iso_checksum_url"`, `"iso_url"`, and `"iso_version"` variables in the `template.json` file. After that, run `packer build -only=virtualbox-iso template.json` and you should be golden.
